...
title: Escaques
categories: ["web"]
excerpt: Online chess school
image: "/images/projects/escaques_logo.jpg"
button:
  label: integrate
  link: "#"
draft: false
meta_title: "Escaques - Online chess academy with real teachers"
description: Escaques is an online chess academy focused on real coaching, group classes, and individual lessons from home.
content: Discover an education-first chess platform built around live teachers, practical progression, and a clear enrollment experience.
# banner:
